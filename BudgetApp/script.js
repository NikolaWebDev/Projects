...
var UIController = (function(){
    ...
    var formatNumber = function(num, type){
        ...
        */ 
        ...
        if(int.length > 3){
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); //input2310, output 2,310
            // output 23,510
        }
    ...
    return {
            ...
            addListItem: function(obj, type){
                ...
                if(type === 'inc'){
                    ...
                    <button class="item__deleted--btn"><i class="ion-ios-close-outline"></i>
                    </button></div></div></div>`;
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var ctrlAddItem = function(){
            ...
            // 5. Calcualate and update budget
            updateBudget();
